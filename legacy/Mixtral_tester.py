...
class MixtralTester(LLMTester):
    def __init__(self, radius=0, ord_limit=31, ord_size=3, temperature=0):
        ...
        """
        super().__init__(self.Mixtral_submit, radius, embedding=self.ADA_embedding)
    ...
    def Mixtral_submit(self, question):
...
def main():
    ...
    curr_tester = MixtralTester(radius=10, ord_limit=31, ord_size=3, temperature=0)
